        ...
        <div className='flex flex-col lg:flex-row items-center space-x-8 '>
            ...
            <div className=''>
                <div className='space-y-4'>
                    ...
                    <div className="w-[580px] h-[210px] flex flex-col justify-center border border-black rounded-2xl  border-b-2 px-9 space-y-6 text-xl hover:border-2">
                ...
                <div className='space-y-4 mt-6 mb-12'>
                    ...
                    <div className='flex flex-col'>
                        <div className='flex flex-row space-x-5'>
                            ...
                            <div className='flex  flex-wrap text-xl h-[160px] ml-1'>
                        ...
                        <div className="w-[280px] h-[215px] border border-black rounded-2xl border-b-2 px-5 space-y-2 text-xl hover:border-2">    
                            ...
                            <div className='flex  flex-wrap  text-xl h-[90px] ml-1'>
                                <div className='flex flex-row items-center'>
                                    <Checkmark />
