    ...
    <div className='flex flex-col lg:flex-row items-center justify-center'>
        <div>
            <img className='transform active:scale-95 transition 
                                    duration-150 cursor-pointer icon-hover3' src={Linemail} width={500}/>
        </div>
        <div onClick={handleCopyClick} 
            className='flex flex-col sm:ml-10 items-center'>
            <h1 className='text-xl md:text-2xl italic mb-6'>You can contact me at</h1>
            <div className='flex flex-row items-center justify-center rounded-xl w-80 sm:w-96 lg:w-[400px] h-[50px] border border-b-2 border-black py-8 hover:border-2 cursor-pointer'>
