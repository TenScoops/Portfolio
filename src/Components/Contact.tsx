...
return (<div className='flex flex-col items-center justify-center xl:h-screen w-full mb-10 py-3 lg:mb-0 tracking-widest '>
    ...
    <div className='flex flex-col lg:flex-row items-center justify-center'>
        ...
        <div onClick={handleCopyClick} 
            className='flex flex-col sm:mr-10 items-center slide-right'>
        ...
        <div className='flex flex-col items-center space-y-6 slide-left'>
            <div>
