...
const paragraph = () =>{
    return <p className=''>
        "<strong>ImaginAI</strong> is a design concept for an image generator that transforms ideas into high-quality 
...
const ImaginAi:React.FC<ImaginAIProps> = ({handleSectionClick}) =>{
    ...
    return(<div className="flex flex-col  items-center xl:h-screen mt-24 mb-20">
        {/* < div className="fixed top-5 left-5 xl:hidden z-50 p-0 m-0"><RocketIcon2 /></div> */}
         ...
         <div className= {`${openMore?'flex':'hidden'} flex-col lg:flex-row justify-center items-center w-full mt-12 pr-12 slide-up2`}>
