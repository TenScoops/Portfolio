...
const Projects = ()=> {
    ...
    <div className="flex flex-col items-center h-screen  w-full tracking-widest mt-28 mb-10 ">
        ...
        <div className="flex flex-col md:flex-row items-center">
            <p className="sm0:text-lg lg:text-xl md:mr-10 order-2 md:order-1 mt-10 md:mt-0 md:pl-0 typewriter2">"<span className="italic">brr</span>...Which project would you like to see?"</p>
