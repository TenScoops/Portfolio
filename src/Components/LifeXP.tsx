...
const paragraph = () =>{
    return <p className=''>
        "<span className='italic'>brr</span>... <strong>LifeXP</strong> combines gamification with tools for emotional well-being and personal growth. By combining game-like features with resources 
